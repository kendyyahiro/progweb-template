		...
		@if(count($favoritos) != 0)
			...
			<div class="col-12 col-sm-6 col-lg-4">
				<div class="card" style="width: 100%;">
					<a href="{{ route('produto/show', $favorito->produto->id) }}"><img class="produto-anunciado card-img-top" src="{{ asset($favorito->produto->imagens->imagem) }}" alt="{{ $favorito->produto->nome }}"></a>
					<div class="card-body">
